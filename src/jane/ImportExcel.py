...
class ImportExcel(object):
    ...
    def __init__(self):
        ...
        self.accountList=nrd.adjustAccountList(self.accountList)
    ...
    def loadFiles(self):
        for file in self.config1:
            ...
            if(budgetN!=''):
                ...
                budgetDf=nrd.normalize('f18',rawBudget)
            ...
            if(actualN!=''):   
                ...
                actualDf=nrd.normalize('b18',rawActual)
            ...
            if(priorN!=''):
                ...
                priorDf=nrd.normalize('a17',rawPrior)
